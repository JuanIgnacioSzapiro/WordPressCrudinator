...
class CampoClave extends TipoMetaBox
{
    public function __construct(
        ...
        $this->set_tipo_de_input('string');
        $this->set_es_campo_opcional(false);
    }
    public function generar_fragmento_html($post, $llave)
    {
        if (!$this->get_clonable()) {
            ...
            <input type="password" id="<?php echo esc_attr($meta_key); ?>" name="<?php echo esc_attr($meta_key); ?>"
                ...
                <div class="clonable-fields-texto">
                    ...
                    foreach ($values as $value) { ?>
                        <div class="clonable-field-texto">
                            <input type="password" name="<?php echo esc_attr($meta_key); ?>[]" value="<?php echo esc_attr($value); ?>"
